-- =====================================================
-- SCRIPT SQL PARA BASE DE DATOS backend_user
-- Sistema de Reservas TecUnify
-- =====================================================

-- Conectar a la base de datos backend_user antes de ejecutar este script
-- \c backend_user;
...
-- =====================================================
SELECT '🎉 BASE DE DATOS backend_user CONFIGURADA EXITOSAMENTE!' as mensaje;
